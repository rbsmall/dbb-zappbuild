...
sortedList.each { buildFile ->
	...
	String rules = props.getFileProperty('jcl_resolutionRules', buildFile)
	String jcl_srcPDS = props.getFileProperty('jcl_srcPDS', buildFile)
	DependencyResolver dependencyResolver = buildUtils.createDependencyResolver(buildFile, rules)
	buildUtils.copySourceFiles(buildFile, jcl_srcPDS, props.jcl_procPDS, dependencyResolver)	
