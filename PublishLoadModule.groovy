...
def workDir = properties.buildOutDir
def loadDatasets = properties.loadDatasets

println "***RBS: workDir - ${workDir}"
...
assert loadCount > 0, "There are no modules to publish"

//Create a temporary directory on zFS to copy the modules from data sets to
...
println "Number of modules to publish: $loadCount"
